<div class="modal fade" id="paperman" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <br>ATTACHMENT: 1686TD:PsyInterview69:AveryGebsen.avi
        <br>
        ...
        <br>
        <br>CONCLUSION: Let's hire him. I don't want to get insomia thinking why the hell this kid has a Tauroscene weapon while only being able to fold papers. Like. How?
        
        <hr>
        Text Message by <span class="cts-thomas"></span> to <span class="cts-george"></span>
        <br>TIME: 1686, SR 12th Fall
        <br>
        <br>You could've had him show what the weapon does?
        
        <hr>
        Text Message by <span class="cts-gamora"></span> to <span class="cts-george"></span>
        <br>TIME: 1686, SR 12th Fall
        <br>
