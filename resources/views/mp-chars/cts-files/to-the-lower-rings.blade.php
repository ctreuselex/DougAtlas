<div class="modal fade" id="to-the-lower-rings" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <br>
        <br>I know this is a mission report and it must be formal. But you know me, writing reports ain't my thing.
        <br>
        <br>Mission 'GETTHEMBLOODYDOGS' is successful. We dispatched those murderous and purse snatching dogs spotted on S, L, Aeros as briefed. Turns out that those dogs weren't actual dogs, but guys and lads that have some kind of transformation abilities. I don't know if this has anything to do with myst - which is a subject I am considered very gifted on - but there is no trace of myst activity around the area, ask Vriskvin for details and blame him if the details are wrong.
        <br>
