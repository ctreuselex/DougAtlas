	...
	<?php 
		...
		$charability = array(
			...
			array ('name'=>"Oak Skin", 'sk'=>'sk3',
				'des'=>"Covers an ally with bark which gives a significant physical |fortify| while also preventing them from getting |thundershock|. Uesing it on herself will make her appear as an ally to enemies units as long as she uses it before any enemy sees her and not all enemy is present to see her in her current disguise."),
