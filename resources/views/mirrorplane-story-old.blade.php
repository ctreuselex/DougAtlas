...
$mirChaps = array(
    array('og'=>'in','title'=>"The Sun",
        'point'=> array(
            "set|The Anchor Bar, Luminos",
            "Eagle tells Valkyr about the Anchor bar, to which he has doubts, but then replies the obvious reasoning as to why she thinks the bar called the \"Anchor\" is related to a group called the \"Ark\".",
            "Valkyr talks to the a guy who likes drinking bleach--but it's not really bleach as the bartender says, orders a similar drink for himself, and asks him if he have seen a girl which looks like the picture he's holding.",
            "The bartender gives Valkyr his drink--which is actual bleach--and spits it out shouting \"Bleach!\" as if it's not his order. \"What a bummer\" says the guy.",
            "Noemi reveals herself in extra dramatic ways whips a vine holding a bottle of bleach asking Valkyr if he wants more, adding that if poisoning him with bleach was this easy, they probably would have been free of annoyance since forever.",
            "Like always, Noemi gets ignored as Zedrik appears out of the backdoor and Valkyr quickly recognizes him as his other half.",
            "After a minute of staring, Noemi comments about not getting the bar destroyed whenever they decide to brawl, but well, she gets ignored, and the fights ensues.",
            "During the fight, Valkyr and Zedrik are able to cur each others' limbs and regenerates them back from the ashes, laughing at their abilities and asking themselves to just die already",
            "The bar burns down and Noemi is disappointed in the back as the Psykeepers arrives and surrounds the area.",
            "Zedrik wins with a last stab on Valkyr's chest, hoping that he can stay longer to actually kill Valkyr. But he needs to run and leaves, setting up Valkyr as an arsonist."),
        'char'=>'valkyr,noemi,zedrik'
        ),
    array('og'=>'in','title'=>"The Moon",
        'point'=> array(
            "set|Vriskvin's Office, Geios",
            "Maximus reports to Vriskvin, who has been busy looking down the city from his office as the head of Geios, about a stolen shipment of weapons from the lower Landar Industries' factories, along with the fire which originated from the Anchor.",
            "A hooded attacker crashes open through the door and fires a jet of water at the two, which Maximus blocks with his amazing myst shield.",
            "The attacker revealed himself as Moon, who is supposed to be dead 2 cycles ago. Vriskvin then challenges him to a fight, asking Maximus to step aside.",
            "Fight happened with Vriskvin winning by smashing Moon's head with a hammer, shattering him like glass.",
            "The real Moon claps beside Maximus commenting how Vriskvin didn't even has a second thought about killing him.",
            "Vriskvin asks Moon about his ressurection, but not even him can give answers to that question. All he knows is that there is a reason as to why he is brought back; and that is to avenge that death of his family, and find out how he died.",
            "Asked why he even bothered to come fight Vriskvin, Moon says that he wants his friends to know that he is alive, but he does not want them to interfere with his path."),
        'char'=>'maximus,vriskvin,moon'
        ),
    array('og'=>'in','title'=>"The Stars",
        'point'=> array(
            "set|Middle Ring Wall, Geios",
            "Told to hunt down the \"Weaver\", Herschel and Rigel illegally climbs up the middle ring of Geios to get to the said prison the \"Weaver\" is supposed to be held in.",
            "Killing at least 8 fodder guards on their way, the duo found their not-so-evil-sister Kalli, waiting for them at the edge of the wall, along with her also-not-evil-twins sidekicks; June and May.",
            "As Rigel insults their lame introduction, which involves carefully lit sets of doors, everybody fought for the sake of fighting scenes.",
            "Rigel took care of the twins while Herschel and Kalli take turns of shooting at each other. Kalli also had too much time counting Herschel's arrows which started from 10 then down to 8.",
            "Ending with Kalli and her sidekicks retreating but not because they lost, but because of prophecy of course, because Kalli is a certified fortune teller now.",
            "Due to them wanting their sister back, Herschel asked Rigel to follow Kalli as she proceed with their mission to find and bring back the \"Weaver\"."),
    ...
    array('og'=>'v1','title'=>"Chapter Eight: Mindless Violence",
        'cont'=>"On location, Herschel sees that there are a lot of people inside the structure, she tells them that she can shoot through at least five walls and would need a clear shot to succeed in completely immobilizing the \"Liberator\", as he calls himself, without killing him. She also can't use her ethereal shot due to the fact that there's a wall blocking. Formulating the plan, Llaxine shows up and asked why she's not invited to her own mission and was really disappointed but still joined in to the fun. The Liberator commences a speach about freedom and equality among people, saying that the wall and rings are nothing but discriminatory apparatuses used by the Dominion to make themselves, and only themselves, powerful. Before he finishes his inspiring speach, Dom and Val lands in with a giant flaming sword from above while Daud and Llaxine come in from each side to separate the crowd. Moon, appears through the backstage and fights off the guards the Liberator has on his side whilst keeping him on stage. Max conjures a powerful wave which cuts the crowd into each side, making way for Herschel's shot. Shortly after, Herschel fires her shot and hits the Liberator through both of his legs, leaving him unable to move. Some of the members of the crusade became more aggressive and dies due to the main characters' awesomeness while some, who are a bit smarter, decided to flee. As the group celebrated their victory inside, Herschel remained out and was visited by Rigel, who then tells her about Kalli being there, watching them.",
        'char'=>'herschel,maximus,valkyr,llaxine,moon,daud,dom,rigel'
        ), 

    // VOLUME 2 
    array('og'=>'v2','title'=>"Chapter One: New Moon",
        'cont'=>"Entering Mystos, Moon reminisces his old life with his family, and as he walks from roof to roof, looking at the floating district of Nimbocolumbus, Moon catches a glimpse of a glowing white wisp escaping from a window below. Curious, Moon decided to check it out only to reveal a woman healing a dying father and his daughter. As the woman sees Moon, he recognizes her as the current Ice Queen, Kianna, but she quickly flies away before he can say anything. Val wakes up to Herschel staring out the window on their abandoned old building, asking her if she ever sleeps and Moon and Dom's whereabouts. Herschel responds that she's simply always cautious and that the other two were gone since last night. Moon goes to his family's home and meets Ceniza, the Head of Mystos, where she asks about his ressurection and that she misses him and his sister a lot. She then invites him to her place and tells him that she's looking for the healer who have been helping people affected by rot; with which Moon tells her that it was Kianna all along. Ceniza then reminds Moon about Amelia's helpful nature, heading to Markus being the head of Mystos as well, frustrated, Moon then decides to leave but Ceniza tried to convince him not to be consumed by vengeance. Dom then meets Moon on his way out and asked him of his true purpose and his response was simply; to have the king answer all the questions that will be asked. Meanwhile, Vriskvin tells Seline about Moon and asks her to get him back to the Dominion.",
        'char'=>'moon,kianna,herschel,valkyr,ceniza,dom,cin,hr,vriskvin,seline'
        ), 
    array('og'=>'v2','title'=>"Chapter Two: Team Ups",
        'cont'=>"Seline finds Val, Herschel, and Dom using Moon's card as a tracker, however, the one she's looking for is missing from the group. Moon, hiding in the shadows, Kianna appears behind him and asked him to stop following her. Moon denies her accusation and told her that it was nothing but a random encounter he told no one about. Kianna then theorizes that, Moon being ressurected, might have something to do with with the existence of rot, as he might have caused imbalace for the disease to happen. Moon then denies her claim again and proceeds to walk away, just as Seline appears in front of him. Seline then drags Moon and then the rest of his new team follows them to higher Mystos, where Vriskvin and team Lupus is waiting for them for a new assignment, which involves rot.",
        'char'=>'valkyr,herschel,dom,seline,moon,kianna,hr,chance,rustom,vines'
        ), 
    array('og'=>'v2','title'=>"Chapter Three: The Revolving Cathedral",
        'cont'=>"As Herschel suggested, both teams, went to revolving Mandalas Cathedral which is suspiciously located in Mystos despite being the month of Aeros. With the help of Valkyr and his hacker friend, Eagle, they were able to get inside the cathedral without much trouble. Splitting up, Moon checks up the higher levels where he was spotted by Lance. Lance, who seem to have no trouble with him sneaking in, decided to show him their patients that is affected by rot; a disease which slowly eats flesh and is aggressive to any form of healing they currently possess. Couple of ice puns later, Lance told Moon that if he wants to investigate the problem, they should start at its root; at the lower Mystos. AS both team walks to the wall between the middle and lower ring, Dom, stops them telling that rot is not something that they should be dealing with. He tells them that it's not something that should exist in the first place and that it might be something manufactured as a weapon. Chance doubts Dom's \"Weaver\" status and tells get off if he doesn't want to cooperate. Rustom thinks that Dom might be up to something, and tells Moon's team to go to Max's, as he is in the industry, as Chance rolls his eyes and drags Vines down to the lower rings. Worried, Rustom and tells Moon to rush and follows down. Scouting the dark, Rustom asks his teammates to go back up as they should be down there while dark, Chance mocks him as he sees a man following them from the other side of the alleys. Chance to runs towards the man and chases, but on a turn, a vial was drop on him but Vines was able to shield them both at the cost of splashing it's content around the area; the area which has Rustom in it.",
        'char'=>'herschel,seline,valkyr,moon,chance,rustom,vines,dom,lance'
        ), 
    array('og'=>'v2','title'=>"Chapter Four: Artificial Winter",
        'cont'=>"Sandra talks to Max and Daud about thir ralationships and the fact that they are build a bomb as the main team shows up on the room. Curious Moon asks about the bomb they were making, which is inspired by their fight with Zedrik. Val warns them that that might not be a good idea to which Sandra agrees. The bomb test failed however, only making a small fire in its place. Team Lupus then appears in the empty room behind them with Rustom being affected by rot. He was then taken to the cathedral where Lance and her snow angels put him into a frozen state to stop the rot from spreading. Val then asks Vines where Rustom got the ability to teleport and she tells him that they have been following Jeanne Ark around for a long time, and that with their encounters with her, Rustom was able to copy her technique, although, in a less efficient way. Vines then suggested the Jeanne might be more than just another higher ranking pawn within the Ark due to the obvious ties in her name. Moon asks Kianna to heal Rustom but she refuses to help especially with Lance's prying eyes. With the cold, slowing down the spread of rot, Ceniza orders Llaxine and Seline to summon winter upon Mystos with the help of the other snow angels.",
        'char'=>'sandra,maximus,daud,moon,valkyr,herschel,dom,rustom,vines,chance,hr,lance,kianna,hr,ceniza,seline,llaxine'
        ), 
    ...
    array('og'=>'v4','title'=>"Chapter Four: Family Matters",
        'cont'=>"",
        'char'=>'moon,theodore'
        ), 
                    ...
                    @foreach($mirChaps as $chap)
                        @if($vol['og']==$chap['og'])
                            <div class="chap-div">
                                ...
                                <ul class="story-div">
                                    @if(isset($chap['point']))
                                        @foreach($chap['point'] as $pnt)
                                            <?php $des = explode("|", $pnt); ?>
                                            @if($des[0]=='set') <li>&#9670; <b>{{ $des[1] }}</b></li>
                                            @else <li>&#9670; {{ $pnt }}</li>
                                            @endif
                                        @endforeach
                                    @else
